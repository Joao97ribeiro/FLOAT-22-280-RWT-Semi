...
---------------------- INPUT FILES ---------------------------------------------
"FLOAT-22-280-RWT-Semi_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
50 VTK_fps  - Frame rate for VTK output (frames per second){will use closest integer multiple of DT} [used only if WrVTK=2]
